...
if (isset($_POST['submit'])) {
	...
	// $qty=$_POST['quality'];
	// $price=$_POST['price'];
	// $price=encrypthis[$submit, $price];
	// $value=$_POST['value'];
	// $price=encrypthis[$submit, $value];
	// $name=$_POST['name'];
	// $summary=$_POST['summary'];
	// $price=encrypthis[$submit, $summary];
	// $review=$_POST['review'];
	// $price=encrypthis[$submit, $review];
...
<head>
	...
	<title>DC Store|Product Details</title>
