...
?>
	...
	<head>
		...
		<title>DC Store|My Account</title>
													...
													?>
														...
														<form class="register-form" role="form" method="post">
															<div class="form-group">
																...
																list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($row['name']), 2),2,null);
																$name = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);
																list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($row['email']), 2),2,null);
																$email = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);
																																														
																?>
																<input type="text" class="form-control unicase-form-control text-input" value="<?php echo $name; ?>" id="name" name="name" required="required">
															</div>
															...
															<div class="form-group">
																...
																<input type="email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" value="<?php echo $email; ?>" readonly>
															</div>
