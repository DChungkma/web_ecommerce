...
$vnp_TmnCode = "SYDFGB6J"; //Website ID in VNPAY System
$vnp_HashSecret = "RPUSFEHJWGTUBAXSBWPTQUMLKRSSQYML"; //Secret key
$vnp_Url = "https://sandbox.vnpayment.vn/paymentv2/vpcpay.html";
$vnp_Returnurl = "http://localhost/source/order-history.php";
