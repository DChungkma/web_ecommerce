									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select name="category" class="span8 tip" onChange="getSubcat(this.value);" required>
														<option value="<?php echo htmlentities($row['cid']); ?>"><?php 
														//Test decryption
														$key='qkwjdiw239&&jdafweihbrhnan&^%$ggdnawhd4njshjwuuO';
														$encryption_key = base64_decode($key);
														list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($row['catname']), 2),2,null);
														$row['catname'] = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);
														
														echo htmlentities($row['catname']); ?></option>
														...
														?>
																...
																$key='qkwjdiw239&&jdafweihbrhnan&^%$ggdnawhd4njshjwuuO';
																$encryption_key = base64_decode($key);
																list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($rw['categoryName']), 2),2,null);
																$rw['categoryName'] = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);

																echo $rw['categoryName']; ?></option>
														<?php }
														} ?>
													</select>
												</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													...
													<select name="subcategory" id="subcategory" class="span8 tip" required>
														<option value="<?php echo htmlentities($row['subcatid']); ?>"><?php 
														//Test decryption
														$key='qkwjdiw239&&jdafweihbrhnan&^%$ggdnawhd4njshjwuuO';
														$encryption_key = base64_decode($key);
														list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($row['subcatname']), 2),2,null);
														$row['subcatname'] = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);
														
														echo htmlentities($row['subcatname']); ?></option>
													</select>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productName" placeholder="Enter Product Name" value="<?php 
													// //Test decryption
													// $key='qkwjdiw239&&jdafweihbrhnan&^%$ggdnawhd4njshjwuuO';
													// $encryption_key = base64_decode($key);
													// list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($row['productName']), 2),2,null);
													// $row['productName'] = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);
													
													echo htmlentities($row['productName']); ?>" class="span8 tip">
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productCompany" placeholder="Enter Product Comapny Name" value="<?php 
													// //Test decryption
													// $key='qkwjdiw239&&jdafweihbrhnan&^%$ggdnawhd4njshjwuuO';
													// $encryption_key = base64_decode($key);
													// list($encrypted_data, $iv) = array_pad(explode('::', base64_decode($row['productCompany']), 2),2,null);
													// $row['productCompany'] = openssl_decrypt($encrypted_data, 'aes-256-cbc', $encryption_key, 0, $iv);
													
													echo htmlentities($row['productCompany']); ?>" class="span8 tip" required>
												</div>
											</div>
											<div class="control-group">
